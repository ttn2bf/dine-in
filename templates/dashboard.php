 <!DOCTYPE html>
 <!--
Sources used: https://cs4640.cs.virginia.edu, https://meyerweb.com/eric/tools/css/reset/, https://getbootstrap.com/docs/5.1/getting-started/introduction/, https://icons.getbootstrap.com/#install, https://developer.mozilla.org/en-US/docs/Web/CSS/:checked, 
-->
 <html lang="en">
     <head>
         <meta charset="utf-8">
     ...
     <body style="background-color: #F1E4E3">
            ...
            <p class="mb-3"><b>Hello, <?=$_SESSION["name"]?> (<?=$_SESSION["email"]?>)!</b></p>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="?command=dashboard" style="background-color: #F1E4E3; border-radius: 25px;">Dashboard</a>
                        </li>
                        <li class="nav-item">
        ...
        <div style="display: flex;flex-wrap:wrap; justify-content:center;">
            ...
            <div class="col-4 flex-item"> 
                ...
                <div id="tagdiv" class="dashcontainer"> 
                <h4>DISCOVER TAGS</h4>
                    <?=$disctags?>
                </div>
            </div> <!--end of col-4-->
        ...
        <script>
            ...
            function clearSearch() {
                ...
                $("input#searchField").val("");
                $("input#searchField").attr("placeholder","Search #tags (All)");
